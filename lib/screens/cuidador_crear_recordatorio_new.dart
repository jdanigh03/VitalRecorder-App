...
class CuidadorCrearRecordatorioNewScreen extends StatefulWidget {
  ...
  const CuidadorCrearRecordatorioNewScreen({
    Key? key,
  ...
  @override
  State<CuidadorCrearRecordatorioNewScreen> createState() =>
      _CuidadorCrearRecordatorioNewScreenState();
}

class _CuidadorCrearRecordatorioNewScreenState
    extends State<CuidadorCrearRecordatorioNewScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          widget.reminder == null
              ? 'Nuevo Recordatorio para $pacienteName'
              : 'Editar Recordatorio',
